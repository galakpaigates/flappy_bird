...
function PipePair:init(y)
	...
	--
	-- add a random number between -7 and 7 to the GAP_HEIGHT inorder
	-- to randomize the gap between the pipes
    self.pipes = {
        ['upper'] = Pipe('top', self.y),
        ['lower'] = Pipe('bottom', self.y + PIPE_HEIGHT + (GAP_HEIGHT + math.random(-7, 7)))
    }
